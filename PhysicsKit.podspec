...
TODO: Add long description of the pod here.
  ...
  s.public_header_files = "PhysicsKit/release/PhysicsKit.framework/Headers/*.h"
  s.source_files = "PhysicsKit/release/PhysicsKit.framework/Headers/*.h"
  s.vendored_frameworks = "PhysicsKit/release/PhysicsKit.framework"
