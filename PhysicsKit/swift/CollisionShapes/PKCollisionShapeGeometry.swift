...
public class PKCollisionShapeGeometry: PKCollisionShape {
    ...
    public init(scnGeometry: SCNGeometry, type: PKCollisionShapeGeometryType) {
        
        let geometry = PKCollisionShapeGeometry.getGeometry(scnGeometry)
        
        switch type {
        case .convex:
            internalShape = PKBCollisionShape(convexHullWith: geometry)
        case .concave:
            internalShape = PKBCollisionShape(triangleMeshWith: geometry)
        }
    }
