...
public extension PHYAction {
    ...
    static func orient(_ rigidBody: PHYRigidBody, by delta: PHYQuaternion, duration: TimeInterval, longestArc: Bool = false) -> PHYAction {
        ...
        return PHYAction(rigidBody: rigidBody, duration: duration, setup: { (rigidBody) -> (Any?) in
            ...
            let interpolatedOrientation: PHYQuaternion = PHYQuaternion.quaternion(sInterpolatedOrientation.vector.x, sInterpolatedOrientation.vector.y, sInterpolatedOrientation.vector.z, sInterpolatedOrientation.vector.w)
    ...
    static func orient(_ rigidBody: PHYRigidBody, to end: PHYQuaternion, duration: TimeInterval, longestArc: Bool = false) -> PHYAction {
