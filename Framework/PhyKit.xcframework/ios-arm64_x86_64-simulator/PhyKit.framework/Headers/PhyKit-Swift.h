...
#ifndef PHYKIT_SWIFT_H
#define PHYKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PhyKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface PHYRigidBody : CPHYRigidBody
- (nonnull instancetype)initWithCollisionShape:(CPHYCollisionShape * _Nonnull)collisionShape rigidBodyType:(CPHYRigidBodyType)rigidBodyType mass:(float)mass SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC6PhyKit10PHYTrigger")
@interface PHYTrigger : CPHYTrigger
- (nonnull instancetype)initWithCollisionShape:(CPHYCollisionShape * _Nonnull)collisionShape SWIFT_UNAVAILABLE;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
